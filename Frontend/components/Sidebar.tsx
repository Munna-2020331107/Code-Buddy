...
export function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  const routes = [
    ...
    { href: "/CloudStorage", label: "Code Storage", icon: <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>, requiresAuth: true },
